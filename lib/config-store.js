...
const FIELDS = ['enabled', 'memoryDir', 'autoInject', 'registerSkill', 'registerTools', 'indexBootMode', 'deferUntilUserSpeaks', 'activeSessionOnly', 'recallEnabled', 'recallIntervalMinMinutes', 'recallIntervalMaxMinutes', 'recallMaxPerSession']
 ...
 * @param {object} [options.base] composition defaults ({enabled, memoryDir, autoInject, registerSkill, registerTools, indexBootMode, recallEnabled})
 */
