...
const FIELDS = ['enabled', 'memoryDir', 'autoInject', 'registerSkill', 'registerTools', 'indexBootMode', 'autoMemory', 'deferUntilUserSpeaks', 'activeSessionOnly', 'recallEnabled', 'recallIntervalMinMinutes', 'recallIntervalMaxMinutes', 'recallMaxPerSession']
 ...
 * @param {object} [options.base] composition defaults ({enabled, memoryDir, autoInject, registerSkill, registerTools, indexBootMode, autoMemory, recallEnabled})
 */
export class MemoryConfigStore {
  constructor(options = {}) {
    ...
    this.base = {
      ...
      autoMemory: options.base?.autoMemory === true,
